...
Instructions: 
    ...
    For help: 
        With The Command built, run the command:  make run ARGS="-help"
    ...
    For Converting Jasmin File To Java File: 
        Use the command:  make generateJasmin ARGS=<FILENAME>
            this will create a .class file in the root directory 
